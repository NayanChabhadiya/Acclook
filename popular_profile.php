              ...
              <div class="rd-navbar-main-bottom rd-navbar-darker">
                <div class="rd-navbar-main-container container">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="popular_profile.php">Popular Profiles</a>
                   </li>
                  </ul>
              ...
              <div class="main-component">
                <article class="heading-component">
                  <div class="heading-component-inner">
                    <h5 class="heading-component-title">Users</h5>
                  </div>
                </article>
                <div class="row">
                  <div class="col-lg-12">
                                ...
                                <tr>
                                  ...
                                  <td><div class="dropdown ml-auto">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                      ...
                                      <li class="dropdown-item"><i class="fa fa-cogs text-primary mr-2"></i><a href="visit_user.php?id=<?php echo $user_list_result['id'];?>">Visit Profile</a></li>
                                    </ul>
                                  </div></td>
        ...
        <!--<div class="footer-classic-aside footer-classic-darken">
          <div class="container">
            <div class="layout-justify">
              <p class="rights">
                <span>Gaming Community <a href="index.php">AccLook</a></span></p>
