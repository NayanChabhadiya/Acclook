                ...
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $game_list_result = mysqli_fetch_assoc($game_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><?php echo $game_list_result['name'];?></td>
                      <td>
                        <div class="dropdown ml-auto">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item">
                              ...
                              <a href="game_delete.php?id=<?php echo $game_list_result['id'];?>" onclick="checkdelete()">
                                Remove Game
                              </a>
                            </li>
                          </ul>
