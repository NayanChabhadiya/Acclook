...
else
{
  ...
  $game_username_list_query = "SELECT * FROM user_game ORDER BY id DESC";
              ...
              <div class="card-body pr-2 pl-2">
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><?php echo $game_username_list_result['id'];?></td>
                      <td><?php echo $game_username_list_result['user_id'];?></td>
