...
else
{
  ...
  $message_list_query = "SELECT * FROM contects ORDER BY id DESC";
  $message_list_data = mysqli_query($conn,$message_list_query);
  $cnt=1;
?>
<!-- Top Section Start -->
                ...
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $message_list_result = mysqli_fetch_assoc($message_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><?php echo $message_list_result['name'];?></td>
                      <td><?php echo $message_list_result['email'];?></td>
                      <td><?php echo $message_list_result['phone'];?></td>
                      <td><?php echo $message_list_result['message'];?></td>
                      <td><?php echo $message_list_result['contected_at'];?></td>
                    </tr>
                    <?php
                      $cnt=$cnt+1;
                      }
