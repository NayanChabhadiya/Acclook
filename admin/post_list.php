              ...
              <div class="card-body pr-2 pl-2">
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><img class="rounded-circle" width="50" src="<?php echo "../".$post_list_result['post_image'];?>" alt=""></td>
                      <td><?php echo $post_list_result['user_id'];?></td>
                      <td><?php echo $post_list_result['game_name'];?></td>
                      <td><?php echo $post_list_result['account_type'];?></td>
                      <td><?php echo $post_list_result['duration'];?></td>
                      <td><?php echo $post_list_result['post_date'];?></td>
                      <td><?php echo $post_list_result['post_content'];?></td>
                      <td><div class="dropdown ml-auto">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                          <li class="dropdown-item"><i class="fa fa-trash text-primary mr-2"></i><a href="post_delete.php?id=<?php echo $post_list_result['post_date'];?>" onclick="checkdelete()">Remove Post</a></li>
                        </ul>
                      </div></td>
                    </tr>
                    <?php
