...
else
{
  ...
  $admin_list_data = mysqli_query($conn,$admin_list_query);
  $cnt=1;
?>
<!-- Top Section Start -->
                ...
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $admin_list_result = mysqli_fetch_assoc($admin_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><img class="rounded-circle" width="50" src="<?php echo $admin_list_result['profile_pic'];?>" alt=""></td>
                      <td><?php echo $admin_list_result['name'];?></td>
                      <td><?php echo $admin_list_result['mobile_no'];?></td>
                      <td><?php echo $admin_list_result['email'];?></td>
                      <td><?php echo $admin_list_result['created_at'];?></td>
                      <td><?php echo $admin_list_result['updated_at'];?></td>
                    </tr>
                    <?php
                      $cnt=$cnt+1;
                      }
