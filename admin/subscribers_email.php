...
else
{
  ...
  $sub_email_list_query = "SELECT * FROM subscribers ORDER BY id DESC";
  $sub_email_list_data = mysqli_query($conn,$sub_email_list_query);
  $cnt=1;
?>
<!-- Top Section Start -->
                ...
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $sub_email_list_result = mysqli_fetch_assoc($sub_email_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><?php echo $sub_email_list_result['email'];?></td>
                      <td><?php echo $sub_email_list_result['subscribed_at'];?></td>
                      <td>
                        <div class="dropdown ml-auto">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item">
                              ...
                              <a href="game_delete.php?id=<?php echo $sub_email_list_result['id'];?>" onclick="checkdelete()">
                                Remove Email
                              </a>
                            </li>
                          </ul>
